...
-- 16 color overrides from terminal:
...
for line in io.lines() do
	...
	if line:find 'hi[!%s]' then
		...
		if not line:find 'gui=' and gui then
			append = append..' gui='..gui
		end
		if not line:find 'guifg=' and guifg then
			append = append..' guifg='..guifg
		end
